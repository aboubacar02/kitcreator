...
const STRINGS = {
  en: {
    ...
    'btn.savePack': 'Save to my workspace',
    'pack.saved': 'Saved!',
    'pack.hooks': 'Ready-to-say hooks',
    'pack.script': 'Shooting script',
    'pack.seoTitle': 'Optimized title',
    'pack.hashtags': 'Hashtags',
    'pack.nextIdeas': 'Your next 3 videos',
  ...
  fr: {
    ...
    'btn.savePack': 'Sauvegarder dans mon espace',
    'pack.saved': 'Sauvegardé !',
    'pack.hooks': 'Crochets prêts à l’écran',
    'pack.script': 'Script prêt à tourner',
    'pack.seoTitle': 'Titre optimisé',
    'pack.hashtags': 'Hashtags',
    'pack.nextIdeas': 'Tes 3 prochaines vidéos',
  ...
  es: {
    ...
    'btn.savePack': 'Guardar en mi espacio',
    'pack.saved': '¡Guardado!',
    'pack.hooks': 'Ganchos listos para decir',
    'pack.script': 'Guion listo para grabar',
    'pack.seoTitle': 'Título optimizado',
    'pack.hashtags': 'Hashtags',
    'pack.nextIdeas': 'Tus próximos 3 vídeos',
