...
const STRINGS = {
  en: {
    ...
    'ws.tabDone': 'Shot',
    'ws.tabFav': 'Favorites',
    'ws.status.draft': 'To shoot',
    'ws.status.done': 'Shot',
    'ws.status.archived': 'Archived',
    'ws.markDone': 'Mark as shot',
    'ws.backToDraft': 'Move back to to-shoot',
    'ws.delete': 'Delete',
    'ws.view': 'View',
    'ws.hide': 'Hide',
    'ws.fav': 'Favorite',
    'ws.confirmDelete': 'Permanently delete this content?',
    'ws.empty.title': 'Your Workspace is empty',
    'ws.empty.text': 'Create your first content pack in seconds.',
    'ws.empty.cta': 'Create my first Pack',
    'ws.improvedVersion': 'Improved version (KitBot)',
    'improve.title': 'Improve with KitBot',
    'improve.result': 'KitBot suggestion',
    'improve.saveVersion': 'Save this version',
    'improve.saved': 'Version saved!',
    'improve.hooks': 'Make the hooks stronger and punchier.',
    'improve.script': 'Rewrite the script with a better rhythm.',
    'improve.cta': 'Improve the call to action to maximize follows.',
    'improve.instagram': 'Adapt this content for Instagram Reels.',
    'improve.youtube': 'Adapt this content for YouTube Shorts.',
    'improve.short30': 'Make a condensed 30-second version.',
    'improve.pedagogic': 'Make the content more educational and structured.',
    'ws.exportAll': 'Export all (.txt)',
    ...
    'form.keywords': 'Keywords to include',
    'form.keywords.placeholder': 'e.g. morning routine, Paris, productivity...',
    ...
    'result.hook': 'Your hooks',
    'result.script': 'Your script',
    'result.hashtag': 'Your hashtags',
    'result.analyze': 'Title analysis',
    'success.label': 'Content generated',
    'empty.title': 'Ready when you are',
    'empty.hint': 'Fill in the form above and hit generate to see your content here.',
    'loading.hook': 'KitBot is crafting scroll-stopping hooks for you…',
    'loading.script': 'KitBot is structuring your script with timecodes…',
    'loading.hashtag': 'KitBot is mixing broad and niche hashtags for max reach…',
    'loading.title': 'KitBot is scoring your title and its click potential…',
    'loading.pack': 'KitBot is assembling your full content pack…',
    ...
    'errors.title': 'Generation failed',
  ...
  fr: {
    ...
    'ws.title': 'Mon Workspace',
    'ws.items': 'contenus',
    'ws.tabAll': 'Tous',
    'ws.tabTodo': 'À tourner',
    'ws.tabDone': 'Tournés',
    'ws.tabFav': 'Favoris',
    'ws.status.draft': 'À tourner',
    'ws.status.done': 'Tourné',
    'ws.status.archived': 'Archivé',
    'ws.markDone': 'Marquer comme tourné',
    'ws.backToDraft': 'Remettre à tourner',
    'ws.delete': 'Supprimer',
    'ws.view': 'Voir',
    'ws.hide': 'Masquer',
    'ws.fav': 'Favori',
    'ws.confirmDelete': 'Supprimer ce contenu définitivement ?',
    'ws.empty.title': 'Ton Workspace est vide',
    'ws.empty.text': 'Crée ton premier pack de contenu en quelques secondes.',
    'ws.empty.cta': 'Créer mon premier Pack',
    'ws.improvedVersion': 'Version améliorée (KitBot)',
    'improve.title': 'Améliorer avec KitBot',
    'improve.result': 'Proposition de KitBot',
    'improve.saveVersion': 'Sauvegarder cette version',
    'improve.saved': 'Version sauvegardée !',
    'improve.hooks': 'Rends les accroches plus fortes et percutantes.',
    'improve.script': 'Réécris le script pour qu’il soit plus rythmé.',
    'improve.cta': 'Améliore l’appel à l’action pour maximiser les abonnements.',
    'improve.instagram': 'Adapte ce contenu pour Instagram Reels.',
    'improve.youtube': 'Adapte ce contenu pour YouTube Shorts.',
    ...
    'ws.exportAll': 'Tout exporter (.txt)',
    ...
    'form.keywords': 'Mots-clés à inclure',
    'form.keywords.placeholder': 'ex. routine du matin, Paris, productivité...',
    ...
    'result.copy': 'Copier',
    'result.copied': 'Copié !',
    'result.hook': 'Tes accroches',
    'result.script': 'Ton script',
    'result.hashtag': 'Tes hashtags',
    'result.analyze': 'Analyse du titre',
    'success.label': 'Contenu généré',
    'empty.title': 'On est prêts — à toi de jouer',
    'empty.hint': 'Renseigne le formulaire ci-dessus et lance la génération pour voir ton contenu ici.',
    'loading.hook': 'KitBot rédige des accroches qui stoppent le scroll…',
    'loading.script': 'KitBot structure ton script avec ses timecodes…',
    'loading.hashtag': 'KitBot mixe hashtags large et de niche pour ta portée…',
    'loading.title': 'KitBot note ton titre et son potentiel de clic…',
    'loading.pack': 'KitBot assemble ton pack de contenu complet…',
    ...
    'errors.title': 'Échec de la génération',
  ...
  es: {
    ...
    'ws.items': 'contenidos',
    'ws.tabAll': 'Todos',
    'ws.tabTodo': 'Por grabar',
    'ws.tabDone': 'Grabados',
    'ws.tabFav': 'Favoritos',
    'ws.status.draft': 'Por grabar',
    'ws.status.done': 'Grabado',
    'ws.status.archived': 'Archivado',
    'ws.markDone': 'Marcar como grabado',
    'ws.backToDraft': 'Volver a por grabar',
    'ws.delete': 'Eliminar',
    'ws.view': 'Ver',
    'ws.hide': 'Ocultar',
    'ws.fav': 'Favorito',
    'ws.confirmDelete': '¿Eliminar este contenido definitivamente?',
    'ws.empty.title': 'Tu espacio está vacío',
    'ws.empty.text': 'Crea tu primer pack de contenido en segundos.',
    'ws.empty.cta': 'Crear mi primer Pack',
    'ws.improvedVersion': 'Versión mejorada (KitBot)',
    'improve.title': 'Mejorar con KitBot',
    'improve.result': 'Propuesta de KitBot',
    'improve.saveVersion': 'Guardar esta versión',
    'improve.saved': '¡Versión guardada!',
    'improve.hooks': 'Haz los ganchos más fuertes e impactantes.',
    'improve.script': 'Reescribe el guion con mejor ritmo.',
    'improve.cta': 'Mejora la llamada a la acción para maximizar suscriptores.',
    'improve.instagram': 'Adapta este contenido para Instagram Reels.',
    'improve.youtube': 'Adapta este contenido para YouTube Shorts.',
    'improve.short30': 'Haz una versión condensada de 30 segundos.',
    'improve.pedagogic': 'Haz el contenido más educativo y estructurado.',
    'ws.exportAll': 'Exportar todo (.txt)',
    ...
    'form.keywords': 'Palabras clave a incluir',
    'form.keywords.placeholder': 'ej. rutina matutina, París, productividad...',
    ...
    'result.hook': 'Tus ganchos',
    'result.script': 'Tu guion',
    'result.hashtag': 'Tus hashtags',
    'result.analyze': 'Análisis del título',
    'success.label': 'Contenido generado',
    'empty.title': 'Listo cuando tú lo estés',
    'empty.hint': 'Completa el formulario de arriba y genera para ver tu contenido aquí.',
    'loading.hook': 'KitBot está creando ganchos que detienen el scroll…',
    'loading.script': 'KitBot está estructurando tu guion con marcas de tiempo…',
    'loading.hashtag': 'KitBot mezcla hashtags amplios y de nicho para más alcance…',
    'loading.title': 'KitBot está puntuando tu título y su potencial de clic…',
    'loading.pack': 'KitBot está montando tu pack de contenido completo…',
    ...
    'errors.title': 'Fallo en la generación',
